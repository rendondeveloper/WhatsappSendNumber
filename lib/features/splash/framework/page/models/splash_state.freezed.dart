...
mixin _$SplashState {
  ...
  NavigationState get navigation => throw _privateConstructorUsedError;
...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ViewEvent viewEvent, NavigationState navigation});

  $NavigationStateCopyWith<$Res> get navigation;
}
...
class _$SplashStateCopyWithImpl<$Res, $Val extends SplashState>
  ...
  @pragma('vm:prefer-inline')
  $NavigationStateCopyWith<$Res> get navigation {
    return $NavigationStateCopyWith<$Res>(_value.navigation, (value) {
...
class _$_SplashState extends _SplashState {
  const _$_SplashState(
      {this.viewEvent = const EventLoading(),
  ...
  @override
  String toString() {
    return 'SplashState(viewEvent: $viewEvent, navigation: $navigation)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, viewEvent, navigation);
...
abstract class _SplashState extends SplashState {
  const factory _SplashState(
      {final ViewEvent viewEvent,
      final NavigationState navigation}) = _$_SplashState;
